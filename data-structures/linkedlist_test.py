...
class TestProgram(unittest.TestCase):
    ...
    def test_case4(self):
        ...
        self.assertEqual(getNodeValuesHeadToTail(
            linkedList), [1, 2, 3, 3, 3, 6, 7])
        self.assertEqual(getNodeValuesTailToHead(
            linkedList), [7, 6, 3, 3, 3, 2, 1])
        expectHeadTail(self, linkedList, first, seventh)
        linkedList.remove(second)
        self.assertEqual(getNodeValuesHeadToTail(
            linkedList), [1, 3, 3, 3, 6, 7])
        self.assertEqual(getNodeValuesTailToHead(
            linkedList), [7, 6, 3, 3, 3, 1])
        expectHeadTail(self, linkedList, first, seventh)
        linkedList.removeNodesWithValue(1)
    ...
    def test_case5(self):
        ...
        self.assertEqual(getNodeValuesHeadToTail(
            linkedList), [3, 5, 2, 1, 4, 6])
        self.assertEqual(getNodeValuesTailToHead(
            linkedList), [6, 4, 1, 2, 5, 3])
        expectHeadTail(self, linkedList, third, sixth)
        linkedList.insertAfter(second, seventh)
        self.assertEqual(getNodeValuesHeadToTail(
            linkedList), [3, 5, 2, 7, 1, 4, 6])
        self.assertEqual(getNodeValuesTailToHead(
            linkedList), [6, 4, 1, 7, 2, 5, 3])
        expectHeadTail(self, linkedList, third, sixth)
    ...
    def test_case6(self):
        ...
        self.assertEqual(getNodeValuesHeadToTail(
            linkedList), [6, 2, 4, 5, 1, 3])
        self.assertEqual(getNodeValuesTailToHead(
            linkedList), [3, 1, 5, 4, 2, 6])
        expectHeadTail(self, linkedList, sixth, third)
        linkedList.insertBefore(first, seventh)
        self.assertEqual(getNodeValuesHeadToTail(
            linkedList), [6, 2, 4, 5, 7, 1, 3])
        self.assertEqual(getNodeValuesTailToHead(
            linkedList), [3, 1, 7, 5, 4, 2, 6])
        expectHeadTail(self, linkedList, sixth, third)
    ...
    def test_case7(self):
        ...
        self.assertEqual(getNodeValuesHeadToTail(
            linkedList), [6, 2, 5, 7, 1, 3, 4])
        self.assertEqual(getNodeValuesTailToHead(
            linkedList), [4, 3, 1, 7, 5, 2, 6])
